...
/* ---------- Keys ---------- */
export type ItemKey = "updateQty" | "updateVariant" | "deleteItem";

export type ActionKey = "showList" | "createItem" | "deleteItemsSelected" | "deleteItemsAll";

/* ---------- Generic helpers ---------- */
export type ActionState<T> = Record<ActionKey, T>;
export type ItemState<T> = Record<string, Partial<Record<ItemKey, T>>>;
