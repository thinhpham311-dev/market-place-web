...
const ProActions: React.FC<ProActionsProps> = ({ storeKey, sku, spu, onAddToCart }) => {
    const { currentQuantity } = useAppSelector(selectQuantitySelectorByStoreKey(storeKey))
    ...
    return (
        <Card className="border-none shadow-none">
            <CardContent className="p-3 flex gap-3">
                ...
                <Button size="lg" variant="default" onClick={handleAddToCart}>
                    <MdShoppingCartCheckout /> <span>Buy Now</span>
                </Button>
            </CardContent>
        </Card>
    );
