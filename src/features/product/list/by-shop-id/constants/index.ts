...
export const PRO_LIST_BY_SHOPID = "PRO_LIST_BY_SHOPID";
export const PRO_LIST_BY_SHOPID_CACHE_KEY = "PRO_LIST_BY_SHOPID_CACHE_KEY";
export const PRO_LIST_BY_SHOPID_TAG = "PRO_LIST_BY_SHOPID_TAG";
export const PRO_LIST_BY_SHOPID_TTL = 5 * 60 * 1000; // 5 minutes
export const PRO_LIST_BY_SHOPID_RETRIES = 2;
export const PRO_LIST_BY_SHOPID_RETRY_DELAY = 500; // 0.5 second

export const DEFAULT_SHOP_ID = "962794";
