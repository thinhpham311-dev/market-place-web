            ...
            <Card className="lg:w-1/3 md:w-1/2 w-full mx-auto">
                ...
                <CardContent>
                    ...
                    >
                        ...
                        <FormSelect name="gender" options={[{ name: "male", value: "male" }, { name: "female", value: "female" }]} label="Choose your gender" placeholder="Please choose gender" formSchema={FormSchema} />
