...
// Components
import { Card, CardContent, CardTitle, CardDescription } from '@/components/ui/molecules';


export default function ProductDetailDescription() {
    return (
        <Card className='md:py-6 p-0 space-y-3 lg:col-span-3 md:col-span-3 col-span-1 border-none'>
