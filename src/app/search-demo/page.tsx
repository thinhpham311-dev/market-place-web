      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="max-w-lg mx-auto text-sm sm:text-base text-stone-400">
            A state-of-the-art live search component leveraging debouncing, Axios request aborting,
            client cache mapping, and strict accessibility.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-stone-950 border border-stone-800 rounded-2xl p-5 flex flex-col h-[320px]">
            <div className="flex items-center gap-2 border-b border-stone-800 pb-3 mb-3">
              ...
              <h3 className="font-semibold text-sm tracking-wide text-stone-200">
            ...
            <div className="flex-1 overflow-y-auto space-y-2 font-mono text-[11px] leading-relaxed pr-1 scrollbar-thin scrollbar-thumb-stone-800 scrollbar-track-transparent">
              {logs.length === 0 ? (
                <div className="text-stone-600 italic text-center pt-20">
                  Console waiting for search activity...
                </div>
              ) : (
                logs.map((log) => (
              ...
              {selectedProduct ? (
                <div className="flex items-start gap-4 p-3 bg-stone-900/80 rounded-xl border border-stone-800">
                  ...
                  <div className="min-w-0">
                    <h4 className="font-semibold text-stone-100 text-sm leading-snug">
                ...
                <div className="flex flex-col items-center justify-center text-center py-8 text-stone-500">
                  ...
                  <p className="text-[10px] text-stone-600 mt-1">
                    Select a suggestion in the dropdown via mouse or keyboard.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="bg-stone-900/30 border border-stone-800 rounded-2xl p-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-stone-400">
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 pl-1">
              <li>
                Press{" "}
                <kbd className="bg-stone-800 px-1 py-0.5 rounded border border-stone-750 text-stone-300">
                  Ctrl + K
                </kbd>{" "}
                or{" "}
                <kbd className="bg-stone-800 px-1 py-0.5 rounded border border-stone-750 text-stone-300">
              ...
              <li>
                ...
                to select the highlighted element.
              </li>
              <li>
                Press{" "}
                <kbd className="bg-stone-800 px-1 py-0.5 rounded border border-stone-750 text-stone-300">
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 pl-1">
              <li>
                <strong>Cancellation:</strong> Requests cancelled mid-flight via{" "}
                <code className="text-orange-400">AbortController</code>.
              </li>
              <li>
                <strong>Sync Cache:</strong> Map caching skips network load on duplicate
                back-to-back entries.
              </li>
              <li>
                <strong>Debounce:</strong> Restricts API calling overhead to 300ms.
              </li>
              <li>
                <strong>Clean UI:</strong> Dynamic loading skeletons and responsive layouts.
              </li>
            </ul>
          </div>
        </div>
