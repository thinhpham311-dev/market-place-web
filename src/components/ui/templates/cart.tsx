            ...
            <div className="lg:col-span-1 md:col-span-1 col-span-1 h-full">
                <Card className="border-none gap-y-10 sticky top-[80px]">
                    <CardHeader className="grid grid-rows-2 grid-flow-col p-0  justify-between items-start">
                        ...
                        <TooltipWrapper content="Edit Cart">
                    ...
                    <CardContent className="space-y-5 p-0">
                        <CardDescription className="flex items-center justify-between">
                            <div className="flex space-x-2 items-center">
                                ...
                                <TooltipWrapper content="The subtotal reflects the total price of your order before any applicable discounts. It does not include shipping costs and taxes."><CircleHelp size={20} /></TooltipWrapper>
                            </div>
                            <span>
                                $170.00
                            </span>
