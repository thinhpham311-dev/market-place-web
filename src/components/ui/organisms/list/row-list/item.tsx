...
export const RowListItem = ({ item: { name, image, article, price, discountPrice }, isCheckBox }: IItemProps) => {
    ...
    return (
        <Card layout="horizontal" className=" mb-3 last:mb-0 items-center">
            <CardImage src={image ?? "https://res.cloudinary.com/dgincjt1i/image/upload/v1724934297/samples/man-on-a-street.jpg"} alt="" className="rounded-md  w-1/2  h-[180px] bg-slate-600 cursor-pointer p-0" onClick={() => router.push("/products/1")} />
