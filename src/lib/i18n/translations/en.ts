...
export const en: TranslationDictionary = {
  ...
  cart_delete_all_confirm_title: "Confirm Delete All",
  cart_delete_all_confirm_desc: "Are you sure you want to remove all items from your cart?",
  cart_delete_all_confirm_button: "Delete All",
  common_cancel: "Cancel",
  cart_checkout: "Check Out",
  cart_total: "Total Payment",
  cart_subtotal: "Subtotal",
  cart_discount: "Discount",
  cart_total_savings: "Savings",
  ...
  brand_logo_alt: "Mini Market Logo",
  footer_brand_desc:
  ...
  search_scope_marketplace: "In Mini Market",
  ...
  sidebar_marketplace_update: "Mini Market Update",
