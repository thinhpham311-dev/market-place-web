...
export const ja: TranslationDictionary = {
  ...
  from_the_same_shop_desc: "現在表示中のショップからのその他の商品です。",
  products_from_shop: "ショップの商品",
  ...
  search_image_results_desc: "撮影した画像と商品サムネイルを比較し、見た目が近い商品を表示します。",
  ...
  daily_discover_recommended_desc: "デフォルトの発見フィードを基にしたバランスの良いおすすめです。",
  ...
  cart_delete_all_confirm_title: "すべての削除の確認",
  cart_delete_all_confirm_desc: "カートからすべての商品を削除してもよろしいですか？",
  cart_delete_all_confirm_button: "すべて削除",
  common_cancel: "キャンセル",
  cart_checkout: "チェックアウト",
  cart_total: "お支払い合計",
  cart_subtotal: "小計",
  cart_discount: "割引",
  cart_total_savings: "節約額",
  cart_discount_applied: "割引が適用されました",
  ...
  sidebar_marketplace_update: "Mini Market 更新",
