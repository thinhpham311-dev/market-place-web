...
export const vi: TranslationDictionary = {
  ...
  daily_discover_bundle_deals_desc: "Các combo giá tốt được ưu tiên hiển thị trong luồng khám phá.",
  daily_discover_recommended_desc: "Các gợi ý cân bằng dựa trên luồng khám phá mặc định của sàn.",
  daily_discover_trending_desc: "Sản phẩm được ưu tiên theo độ phổ biến khi nguồn dữ liệu hỗ trợ.",
  daily_discover_fast_delivery_desc:
    "Các lựa chọn mua nhanh được đẩy lên trước trong trang khám phá hiện tại.",
  daily_discover_top_rated_desc: "Sản phẩm có điểm đánh giá hiển thị tốt nhất trên trang hiện tại.",
  daily_discover_best_value_desc: "Các sản phẩm giá thấp hơn được ưu tiên cho nhu cầu săn giá tốt.",
  ...
  cart_delete_all_confirm_title: "Xác nhận xóa tất cả",
  cart_delete_all_confirm_desc: "Bạn có chắc chắn muốn xóa toàn bộ sản phẩm khỏi giỏ hàng không?",
  cart_delete_all_confirm_button: "Xóa tất cả",
  common_cancel: "Hủy",
  cart_checkout: "Thanh toán",
  cart_total: "Tổng thanh toán",
  cart_subtotal: "Tổng tiền hàng",
  cart_discount: "Giảm giá",
  cart_total_savings: "Tiết kiệm",
  cart_discount_applied: "Đã áp dụng giảm giá",
  ...
  cart_item_removed_desc: "Sản phẩm {product} - {variants} x {quantity} đã được xóa khỏi giỏ hàng.",
  cart_remove_tooltip: "Xóa sản phẩm khỏi giỏ hàng",
  cart_add_success_title: "Đã thêm vào giỏ hàng thành công",
  cart_add_success_desc: "Sản phẩm {product} - {variants} x {quantity} đã được thêm vào giỏ hàng.",
